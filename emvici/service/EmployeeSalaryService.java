...
public class EmployeeSalaryService {
    ...
    public void showPageUserList(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
        ...
        ResultSet data = employeeSalarymodel.getAllUser();// Lấy tất cả dữ liệu người dùng từ cơ sở dữ liệu (trả về ResultSet).
        List<EmployeeSalary> salarys = new ArrayList<>();
        while (data.next()) {
            //Duyệt qua từng hàng dữ liệu trong ResultSet và trích xuất thông tin người dùng.
...
// Tìm và chuyển hướng tới trang JSP
